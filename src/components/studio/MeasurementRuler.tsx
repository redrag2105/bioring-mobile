...
export function MeasurementRuler({ activeIndex, onDecrease, onIncrease, onSelect, rulerRef }: MeasurementRulerProps) {
  ...
  return (
    <View className='elevation-3 flex-row items-center gap-2 rounded-[36px] border-[0.5px] border-ring-primary/10 bg-ring-surface p-2 shadow-md shadow-ring-primary/5'>
      ...
      <Pressable
        ...
        onPress={onDecrease}
        className='elevation-1 h-12 w-12 items-center justify-center rounded-full bg-ring-primary shadow-sm shadow-ring-primary/20 active:opacity-80'
      >
            ...
            return (
              ...
              >
                <Text
                  ...
                  className={`absolute top-[6px] tracking-widest transition-opacity ${
                    isActive
