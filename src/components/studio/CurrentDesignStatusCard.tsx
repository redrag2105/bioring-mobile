...
export function CurrentDesignStatusCard() {
  ...
  return (
    <View className="relative overflow-hidden rounded-[32px] border-[0.5px] border-white/10 shadow-2xl">
      <LinearGradient colors={['#1A3642', '#0C1F27']} className="absolute inset-0" />

      <View className="p-7 gap-6">
        {/* Header Section */}
        ...
        {/* Journey Progress */}
        <View className="relative flex-row justify-between items-center py-4">
          <View className="absolute top-[30px] left-6 right-6 h-[0.5px] bg-white/10" />
                ...
                >
                  ...
                  >
                    ...
                    <Circle
                      ...
                      cy="4"
                      r="1"
                      fill={isCompleted ? THEME.ringAccent : 'rgba(255,255,255,0.2)'}
                    />
                  </Svg>
                </View>
